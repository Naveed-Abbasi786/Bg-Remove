...
export default function Upload(props) {
  ...
  {/* Icon */}
  <div className="absolute lg:left-[65%] lg:top-[4%] flex justify-center inset-x-0  max-[988px]:top-[1%]">
  ...
  {/* Heading */}
  <h1 className="text-gray-700 dark:text-gray-200 w-full font-bold text-xl sm:text-2xl lg:text-3xl tracking-wide text-center mt-4 sm:mt-6  sm:mt-20 mt-20">
