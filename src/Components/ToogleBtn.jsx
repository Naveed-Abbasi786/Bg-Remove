...
import { DarkModeContext } from './Context/UseContext';  // Ensure you're importing the context

export default function ToggleBtn() {
  const { DarkMode, ToggleDarkMode } = useContext(DarkModeContext);  // Use the context here to get current mode and toggling function
        ...
        <FormControlLabel
          control={
            <MaterialUISwitch 
              ...
              onChange={ToggleDarkMode} // Use checked prop to link it to the darkMode state
            />
          }
        />
      </FormGroup>
